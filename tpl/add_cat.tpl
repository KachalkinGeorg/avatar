...
<div class="panel-body" style="font-family: Franklin Gothic Medium;text-transform: uppercase;color: #9f9f9f;">Создание новой категории</div>
<div class="table-responsive">
	<table class="table table-striped">
      <tr>
        ...
        <td width="50%">
		  <input class="edit" type="text" style="width: 300px;" name="name" />
        </td>
      </tr>
      <tr>
        ...
        <td width="50%">
		  <input class="edit" style="width: 300px;" type="text" name="altname" />
        </td>
      </tr>
      <tr>
        ...
        <td width="50%">
		  <input class="radio" type="radio" name="upload" value="1" checked/>&nbsp;&nbsp;<label>да</label>&nbsp;&nbsp;<input class="radio" type="radio" name="upload" value="0" />&nbsp;&nbsp;<label>нет</label>
        </td>
      </tr>
      <tr>
        <td width="50%">Скрыта
        ...
        <td width="50%">
		  <input class="radio" type="radio" name="hidden" value="1" />&nbsp;&nbsp;<label>да</label>&nbsp;&nbsp;<input class="radio" type="radio" name="hidden" value="0" checked/>&nbsp;&nbsp;<label>нет</label>
        </td>
      </tr>
